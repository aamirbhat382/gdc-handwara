        ...
        <section className=" relative max-w-screen-xl mx-auto py-4 px-4 md:px-8">
            ...
            <div className="relative z-10 gap-5 items-center lg:flex">
                <div className="flex-1 max-w-lg py-5 sm:mx-auto sm:text-center lg:max-w-max lg:text-left">
                    ...
                    We believe in team work and mutual consultation.Promote democratic atmosphere and respect for healthy criticism. Pursuance, Patience & preservation are keys to success. Education and empowerment of a girl student ensures elite future civilization
                    </p>
