        ...
        <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                        <img src="https://gdchandwara.edu.in/images/TopLogo.png" className="w-32" />
                        <p className="leading-relaxed mt-2 text-[15px]">
                        Govt Degree College Handwara NAAC Accredited Grade B
                        </p>
                    </div>
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2023 GDC Handwara All rights reserved.
                </div>
            ...
            <hr/>
            <p className="text-center font-bold text-blue-900">Developed By Aamir Hussain Student at  GDC Handwara</p>
            <style jsx>{`
                .svg-icon path,
                .svg-icon polygon,
                .svg-icon rect {
