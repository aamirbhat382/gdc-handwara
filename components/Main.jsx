            ...
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                ...
                <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
                    <div className="relative">
                        <img src="https://scontent.fsxr1-1.fna.fbcdn.net/v/t39.30808-6/308423219_499080168894356_3434206610460592354_n.jpg?stp=dst-jpg_p180x540&_nc_cat=109&ccb=1-7&_nc_sid=e3f864&_nc_ohc=XkdXchQwfJoAX-puT5O&_nc_ht=scontent.fsxr1-1.fna&oh=00_AfAOmlAcEajhoU1tqNjiJAgn-Na5SQ5lViac0_2hs6GYzw&oe=64606609" className="rounded-lg" alt="" />
                    ...
                    <div className="fixed inset-0 w-full h-full flex items-center justify-center">
                        ...
                        <div className="px-4 relative">
                            ...
                            <video className="rounded-lg w-full max-w-2xl" controls autoPlay={true}>
                                <source src="https://res.cloudinary.com/jkstudents/video/upload/v1683686893/SaveInsta.App_-_3098855325797719418_35628922276_aeh2ln.mp4" type="video/mp4" />
                            </video>
                        </div>
                    </div>
                ) : ""
