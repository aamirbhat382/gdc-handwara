...
const Vedio =  ({title,thumbnailImg,videoUrl}) => {
    const features = [
        {
            name: "Trusted",
            icon:
        ...
        <section>
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                    ...
                    The foundation stone of the college was laid in the year 1982 by Hon’ble Minister for Education, J&K Government Handwara, District Kupwara. The academic session started in 1983 in a building provided by Higher Secondary School Handwara. Later the college was shifted to the actual campus at Handwara which is spread over an area of 106 Kanals, in a lush green environment and peaceful area. The college stands affiliated to the University of Kashmir, Srinagar and recognized under 2(f) and 12(b) of UGC Act 1956.
                    </p>
                    <p>
                    The college infrastructure has developed to a large extent. The college represents a perfect platform for the student personality development. Besides regular academic transaction, the college encourages participation of students in various seminars, debates, conferences and value based programmes in order to develop their physical, moral, aesthetic and ethical dimensions.
                    </p>
                   
                </div>
                <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
                    <div className="relative">
                        <img src={thumbnailImg} className="rounded-lg" alt="" />
